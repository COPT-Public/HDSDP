\begin{abstract}
  {{\texttt{HDSDP}}} is a numerical software solving the semidefinite
  ...
  robustness and efficiency, and particularly its advantages on SDP instances featuring low-rank structure and sparsity. The pre-built binary of {{\texttt{HDSDP}}} is currently freely available at \href{https://github.com/COPT-Public/HDSDP}{https://github.com/COPT-Public/HDSDP}.
