...
\revised{Besides the listed features, {{\texttt{HDSDP}}} has a list of additional features, including an adaptively pre-conditioned conjugate gradient solver and multi-threading support. Due to space limit we delay them to the appendix.}
