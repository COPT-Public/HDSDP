...
//    printf("Pardiso time: Numeric: %f Solve: %f Check: %f [Invert %f] Forward: %f Backward: %f \n",
//           dPardisoNumeric, dPardisoSolve, dPardisoPsdCheck, dPardisoInvert, dPardisoForward, dPardisoBackward);
//    printf("Pardiso time: Numeric: %d Solve: %d Check: %d [Invert %d] Forward: %d Backward: %d \n",
